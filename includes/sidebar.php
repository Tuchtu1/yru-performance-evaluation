...
<aside class="w-64 bg-white border-r border-gray-200 min-h-screen">
    <nav class="p-4 space-y-1">
        ...
        <a href="<?php echo url('modules/dashboard/index.php'); ?>"
            class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors <?php echo isActive($_SESSION['user']['role'] . '-dashboard.php'); ?>">
        ...
        <?php if ($_SESSION['user']['role'] === 'staff'): ?>
            ...
            <a href="<?php echo url('modules/evaluation/list.php'); ?>"
                class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors <?php echo isActive('list.php'); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="<?php echo url('modules/evaluation/create.php'); ?>"
                class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors <?php echo isActive('create.php'); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo url('modules/portfolio/index.php'); ?>"
                class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors <?php echo isActive('index.php'); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <?php elseif ($_SESSION['user']['role'] === 'manager'): ?>
            ...
            <a href="<?php echo url('modules/approval/pending-list.php'); ?>"
                class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors <?php echo isActive('pending-list.php'); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="<?php echo url('modules/approval/history.php'); ?>"
                class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors <?php echo isActive('history.php'); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <?php elseif ($_SESSION['user']['role'] === 'admin'): ?>
            ...
            <a href="<?php echo url('modules/configuration/personnel-type.php'); ?>"
                class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors <?php echo isActive('personnel-type.php'); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="<?php echo url('modules/reports/individual.php'); ?>"
            class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors <?php echo isActive('individual.php'); ?>">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <?php if (in_array($_SESSION['user']['role'], ['admin', 'manager'])): ?>
            <a href="<?php echo url('modules/reports/department.php'); ?>"
                class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors <?php echo isActive('department.php'); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="<?php echo url('modules/reports/organization.php'); ?>"
                class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors <?php echo isActive('organization.php'); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
